...
public class DocumentServiceTest {
    ...
    public void setUp() {
        ...
        documentService = new DocumentService(
                ...
                documentMapper,
                null, // instrumentRepository (pas utilisé ici)
                null // utilisateurEnsembleService (pas utilisé ici)
        );
    }
    ...
    public void testGetAll() {
        ...
        // ⚠️ Le record DocumentDto attend 8 paramètres
