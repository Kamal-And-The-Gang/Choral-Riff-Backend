...
//     // Supprimer tous les utilisateurs pour être sûr
//     userRepository.deleteAll();

//     Utilisateur user = new Utilisateur();
//     user.setEmail("user" + System.currentTimeMillis() + "@example.com"); // email unique
//     user.setPrenom("Bob");
//     user.setNom("Bub");
...
class AuthControllerTests {
    ...
    void register_should_return_created_user() throws Exception {
        ...
        dto.setNom("Test");
        dto.setPrenom("User");
        dto.setEmail("registeruser" + System.currentTimeMillis() + "@example.com"); // Email unique
        dto.setMotDePasse("password");
