...
// import fr.afpa.choral_riff.security.CustomUserDetails;
...
//         Utilisateur user = userDetails.getUtilisateur(); // ton Utilisateur JPA
...
public class LoginService {
    ...
    public Map<String, String> login(LoginDTO loginDTO) {
        ...
        // récupérer ton Utilisateur depuis la base avec l'email
